...
Funcionalidade: Processar Callback Pedido
  ...
  Cenario: 01 - Processar callback pedido valido com status de processado - Sucesso
    ...
    E deveria enviar os e-mails esperados
      ...
      | martin_lopes@rafaelmarin.net | no-reply-test@gmail.com | Email de Nota Fiscal - E-Commerce Digital Fictício Ltda | /fixtures/EmailBody-987654351.txt | /fixtures/InvoiceBase64-27250212345678550010000000011234567898765432.txt | nota-fiscal-27250212345678550010000000011234567898765432.png |
